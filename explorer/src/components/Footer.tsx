import { Heart, Github, Globe, Twitter } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/" className="text-slate-400 hover:text-emotional-400 text-sm transition-colors">Validators</a></li>
              <li><a href="/" className="text-slate-400 hover:text-emotional-400 text-sm transition-colors">Staking</a></li>
              <li><a href="/" className="text-slate-400 hover:text-emotional-400 text-sm transition-colors">Governance</a></li>
              <li><a href="/" className="text-slate-400 hover:text-emotional-400 text-sm transition-colors">API Docs</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-slate-400 hover:text-emotional-400 transition-colors">
                <Github className="w-5 h-5" />
              </a>
              <a href="#" className="text-slate-400 hover:text-emotional-400 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://emotionalchain.com" className="text-slate-400 hover:text-emotional-400 transition-colors">
