    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          ...
          <p className="text-2xl font-bold text-white">{formatNumber(1247)}</p>
          <p className="text-green-400 text-sm">+12 in last hour</p>
        </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          ...
          <p className="text-2xl font-bold text-emotional-400">78.5%</p>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          ...
          <p className="text-slate-400 text-sm">8 failed transactions</p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-emotional-400"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2 bg-slate-900 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-emotional-400 appearance-none"
            >
                    ...
                    {tx.emotionalData && (
                      <div className="flex items-center space-x-4 text-xs">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-emotional-400 font-medium">
