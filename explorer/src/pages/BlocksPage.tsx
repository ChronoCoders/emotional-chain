...
export default function BlocksPage() {
  const { data: blocks, isLoading } = useQuery({
    queryKey: ['blocks'],
    queryFn: () => apiClient.getBlocks(50),
  });
  ...
  const totalBlocks = latestBlock?.height || 1000;
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Hash className="w-5 h-5 text-emotional-400" />
          </div>
          <p className="text-2xl font-bold text-emotional-400">82.3%</p>
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-emotional-400 text-lg font-semibold">Proof of Emotion</p>
