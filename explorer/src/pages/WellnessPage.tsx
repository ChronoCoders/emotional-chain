...
export default function WellnessPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Heart className="w-5 h-5 text-emotional-400 heartbeat" />
          </div>
          <p className="text-2xl font-bold text-emotional-400">{networkWellnessScore}%</p>
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-white mb-6 flex items-center">
          <Heart className="w-5 h-5 mr-2 text-emotional-400" />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-900/50 border border-slate-600 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-emotional-400 font-medium">Daily Meditation Bonus</span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-emotional-400 font-semibold">{formatNumber(2847)} EMO</span>
              </div>
              <div className="flex justify-between items-center">
